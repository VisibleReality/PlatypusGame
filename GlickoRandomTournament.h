...
#ifndef PLATYPUSGAME_GLICKORANDOMTOURNAMENT_H
#define PLATYPUSGAME_GLICKORANDOMTOURNAMENT_H
...
#include "include/glicko2/rating.hpp"

class GlickoRandomTournament : public Tournament
{
	struct Standing {
		long wins{};
		long gamesPlayed{};
...
public:
	/**
	 * Construct a new glicko tournament with random pairings.
	 ...
	 */
	GlickoRandomTournament(std::vector<unsigned long>& playerIDs, int percentage);

	GlickoRandomTournament(std::istream saveStream);
...
#endif //PLATYPUSGAME_GLICKORANDOMTOURNAMENT_H
